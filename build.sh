...
DATE=$(date +"%d%m%Y")
TIME=$(date +"-%H.%M.%S")
KERNEL_NAME="Darkstar-Kernel-Stock-v1"
DEVICE="-kenzo-"
...
export KBUILD_BUILD_USER="Gigabyte"
export KBUILD_BUILD_HOST="Darkstar"
export CROSS_COMPILE=/down/down1/bin/prebuilts/gcc/linux-x86/aarch64/aarch64-linux-android-4.9/bin/aarch64-linux-android-
export ARCH="arm64"
export USE_CCACHE=1
